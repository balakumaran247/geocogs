...
class GeoCogsPlugin:
    def __init__(self, iface):
        self.cmd_folder = os.path.split(inspect.getfile(inspect.currentframe()))[0]
    ...
    def about_init(self):
        self.about_action = QAction(QIcon(self.icon),'About', self.iface.mainWindow())
    ...
    def boundarystats_init(self):
        self.boundarystats_action = QAction(QIcon(self.icon),"Boundary Statistics", self.iface.mainWindow())
    ...
    def lulcstats_init(self):
        self.lulcstats_action = QAction(QIcon(self.icon),"LULC Statistics", self.iface.mainWindow())
